                ...
                <div className="container border-top mt-5">
                    <div className="row mt-5">
                        ...
                        <div className="col">
                            ...
                            <br />
                            <a href="" className="text-decoration-none text-muted">NexVest.tech</a>
                            <br />
                            <a href="" className="text-decoration-none text-muted">Press & media</a>
                            <br />
                            <a href="" className="text-decoration-none text-muted">NexVest cares (CSR)</a>
                            <br />
                        </div>
                        <div className="col">
                            <p>Support</p>
                            ...
                            <br />
                            <a href="" className="text-decoration-none text-muted">NexVest blog</a>
                            <br />
                    ...
                    <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
                        <p>
                            NexVest Broking Ltd.: Member of NSE​ &​ BSE – SEBI Registration no.:
                            INZ000031633 CDSL: Depository services through NexVest Securities
                            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
                            through NexVest Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
                            no.: INZ000038238 Registered Address: NexVest Broking Ltd.,
                            #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School,
                            J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any
                            complaints pertaining to securities broking please write to
                            complaints@nexvest.com, for DP related to dp@nexvest.com. Please
                        ...
                        <p>
                            ...
                            claiming to be part of NexVest and offering such services, please
